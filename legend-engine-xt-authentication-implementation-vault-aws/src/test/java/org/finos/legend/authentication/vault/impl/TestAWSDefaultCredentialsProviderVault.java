...
public class TestAWSDefaultCredentialsProviderVault
{
    ...
    public void getSecretAccessKey() throws Exception
    {
        ...
        assertEquals("fake_id", vault.lookupSecret(new AWSSecretsManagerCredentialVaultSecret("ACCESS_KEY_ID", "unused", "unused"), null));
        assertEquals("fake_secret", vault.lookupSecret(new AWSSecretsManagerCredentialVaultSecret("SECRET_ACCESS_KEY", "unused", "unused"), null));
    }
}
