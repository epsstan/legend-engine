...
public class TestJdbcConnectionProvider
{
    ...
    public void testH2ConnectionCreation() throws Exception
    {
        ...
        UserPasswordAuthenticationSpecification authenticationSpecification = new UserPasswordAuthenticationSpecification("sa", new PropertiesFileCredentialVaultSecret("passwordRef1"));
