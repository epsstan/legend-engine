...
public interface IServiceStoreCompilerExtension extends CompilerExtension
{
    ...
    default List<Function3<SecurityScheme, CompileContext, Root_meta_external_store_service_metamodel_ServiceStore, Pair<String,Root_meta_external_store_service_metamodel_SecurityScheme>>> getExtraSecuritySchemeProcessors()
    {
