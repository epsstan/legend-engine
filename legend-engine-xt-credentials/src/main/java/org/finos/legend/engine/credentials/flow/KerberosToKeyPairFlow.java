        ...
        LegendKeypairCredential.Params>
{
    ...
    @Override
    public Supplier<LegendKeypairCredential> makeCredential(Identity identity, LegendKeypairCredential.Params params) throws Exception
    {
        ...
        return () -> new LegendKeypairCredential(this.makeCredential(params.userName(), params.privateKeyVaultReference(), params.passphraseVaultReference()));
    }

    private PrivateKeyCredential makeCredential(String userName, String privateKeyVaultReference, String passPhraseVaultReference)
    {
        PrivateKey privateKey = this.getEncryptedPrivateKey(privateKeyVaultReference, passPhraseVaultReference);
        return new PrivateKeyCredential(userName, privateKey);
    }
