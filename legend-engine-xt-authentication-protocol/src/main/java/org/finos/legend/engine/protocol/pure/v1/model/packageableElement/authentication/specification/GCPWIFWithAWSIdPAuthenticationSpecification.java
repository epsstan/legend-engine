...
public class GCPWIFWithAWSIdPAuthenticationSpecification extends AuthenticationSpecification
{
    ...
    public static class IdPConfiguration
    {
        ...
        public String role;
        public CredentialVaultSecret accessKeyIdVaultReference;
        public CredentialVaultSecret secretAccessKeyIdVaultReference;

        public IdPConfiguration(String region, String accountId, String role, CredentialVaultSecret accessKeyIdVaultReference, CredentialVaultSecret secretAccessKeyIdVaultReference)
        {
            this.region = region;
            this.accountId = accountId;
            this.role = role;
            this.accessKeyIdVaultReference = accessKeyIdVaultReference;
            this.secretAccessKeyIdVaultReference = secretAccessKeyIdVaultReference;
        }
