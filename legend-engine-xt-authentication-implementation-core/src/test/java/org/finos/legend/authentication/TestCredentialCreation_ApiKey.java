...
public class TestCredentialCreation_ApiKey
{
    ...
    public void makeCredentialFromPropertiesVault() throws Exception
    {
        ...
        ApiKeyAuthenticationSpecification authenticationSpecification = new ApiKeyAuthenticationSpecification("location", "key", new PropertiesFileCredentialVaultSecret("reference1"));
