...
public class TestCredentialCreation_UserPassword
{
    ...
    public void makeCredentialFromPropertiesVault() throws Exception
    {
        ...
        UserPasswordAuthenticationSpecification authenticationSpecification = new UserPasswordAuthenticationSpecification("hello", new PropertiesFileCredentialVaultSecret("reference1"));
