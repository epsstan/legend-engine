...
public class TestCredentialProviderEdgeCases
{
    ...
    public void testProviderWithoutAnyRules() throws Exception
    {
        ...
        {
            String expected = "Cannot make credential for configuration of type 'class org.finos.legend.engine.protocol.pure.v1.model.packageableElement.authentication.apikey.ApiKeyAuthenticationSpecification'. No intermediation rules have been configured";
    ...
    public void testProviderWithRuleThatDoesNotMatchSpecificationType() throws Exception
    {
        ...
        {
            String expected = "Cannot make credential. No intermediation rule that matches configuration type 'class org.finos.legend.engine.protocol.pure.v1.model.packageableElement.authentication.apikey.ApiKeyAuthenticationSpecification' and one of these input credential types : [class org.finos.legend.engine.shared.core.identity.credential.AnonymousCredential]";
            assertEquals(expected, e.getMessage());
        }
    }
    ...
    public void testProviderWithRuleThatDoesNotMatchInputCredentialType() throws Exception
    {
        ...
        {
            String expected = "Cannot make credential. No intermediation rule that matches configuration type 'class org.finos.legend.engine.protocol.pure.v1.model.packageableElement.authentication.userpassword.UserPasswordAuthenticationSpecification' and one of these input credential types : [class org.finos.legend.engine.shared.core.identity.credential.AnonymousCredential]";
            assertEquals(expected, e.getMessage());
        }
    }
