...
public class TestCredentialVaultProvider
{
    ...
    public void vaultRegistration() throws Exception
    {
        ...
        Assert.assertEquals(propertiesFileCredentialVault, credentialVaultProvider.getVault(new PropertiesFileCredentialVaultSecret("a")));
        ...
        Assert.assertEquals(systemPropertiesCredentialVault, credentialVaultProvider.getVault(new SystemPropertiesCredentialVaultSecret("a")));
