...
import org.finos.legend.pure.generated.Root_meta_pure_runtime_connection_authentication_PropertiesFileVaultSecret;
...
public class TestAuthenticationDemoCompilationFromGrammar extends TestCompilationFromGrammar.TestCompilationFromGrammarTestSuite
{
    ...
    public void userPasswordAuthentication()
    {
        ...
        Root_meta_pure_runtime_connection_authentication_PropertiesFileVaultSecret propertiesFileVaultSecret = (Root_meta_pure_runtime_connection_authentication_PropertiesFileVaultSecret) credentialVaultSecret;
        assertEquals("reference1", propertiesFileVaultSecret._reference());
    }
